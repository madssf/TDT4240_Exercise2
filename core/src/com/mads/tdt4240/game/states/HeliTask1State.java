...
public class HeliTask1State extends State {
    ...
    public HeliTask1State(GameStateManagerSingleton gsm){
        ...
        exit.setPosition(Game.WIDTH/2 - exit.getTexture().getWidth()/2 ,Game.HEIGHT - exit.getTexture().getHeight());        heli1 = new Heli(Game.WIDTH / 2, Game.HEIGHT - 100);
        heli2 = new Heli(Game.WIDTH / 2, Game.HEIGHT / 2);
        heli3 = new Heli(Game.WIDTH / 2, 100);
